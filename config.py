...
gaussian_noise_config = dnnlib.EasyDict(
    ...
    train_stddev_rng_range=(0, 200.0), # from the paper bbj
    validation_stddev=100.0
)
...
lognormal_noise_config = dnnlib.EasyDict(
    func_name='train.AugmentLogNormal',
    std=0.7)
...
datasets = {
    ...
    'small': dnnlib.EasyDict(dataset_dir='datasets/small'),
    'set68':  dnnlib.EasyDict(dataset_dir='datasets/Set68'),
...
corruption_types = {
    ...
    'lognormal': lognormal_noise_config
}
